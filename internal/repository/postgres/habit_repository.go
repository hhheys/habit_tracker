...
type HabitRepository interface {
	...
	GetUserHabits(userID uint) ([]*models.Habit, error)
...
func NewHabitRepository(db *sql.DB, logger *zap.Logger) HabitRepository {
...
func (r *habitRepositoryImpl) GetUserHabits(userID uint) ([]*models.Habit, error) {
	rows, err := r.DB.Query(`SELECT * FROM habit
